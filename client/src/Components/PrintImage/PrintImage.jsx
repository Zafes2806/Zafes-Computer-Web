            ...
            <div className="print-content" ref={printRef}>
                <div className="print-header">
                    <div className="logo-section">
                        <div className="logo">
                            <div>Zafes Computer</div>
                        </div>
                        <div className="company-info">
                            <div className="company-name">Zafes Computer</div>
                            ...
                            <div>
                                Website: <a href="/">Zafes Computer</a>
                            </div>
                            <div>Fanpage: Zafes Computer</div>
                            <div>
                                <a href="/">Zafes Computer</a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="print-footer">
                    ...
                    <div className="thank-you">ZAFES COMPUTER CẢM ƠN QUÝ KHÁCH</div>
                </div>
            </div>
        </div>
    );
