...
function RegisterUser() {
    ...
    const onFinish = async (values) => {
        try {
            ...
            if (!user?.id) {
                throw new Error('Không thể xác thực phiên đăng ký. Kiểm tra cookie hoặc token.');
            }
            ...
            message.error(error?.response?.data?.message || error?.message || 'Không thể đăng ký tài khoản');
        }
    };
