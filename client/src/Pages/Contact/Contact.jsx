...
import { requestCreateContact } from '../../api';
...
function Contact() {
    ...
    const onFinish = async (values) => {
        ...
        const data = {
            ...
            purchaseIntent: getPurchaseIntentText(),
            purpose: getPurposeText(),
            budget: getBudgetText(),
            deliveryOption: getDeliveryOptionText(),
        };
    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('container')}>
                <Card bordered={false} className={cx('card')}>
                    <Title level={2} style={{ textAlign: 'center', color: '#1890ff', marginBottom: '30px' }}>
                        Zafes Computer - TƯ VẤN BUILD PC Theo Yêu Cầu 24/7
                    </Title>
                    <Paragraph style={{ textAlign: 'center', fontSize: '16px' }}>
                        Zafes Computer là đơn vị chuyên cung cấp PC Gaming - PC Đồ Họa - Linh Kiện PC Chất Lượng -
                        Hiệu Năng Cao - Đẹp Mắt - Giá Cực Tốt.
                    </Paragraph>
