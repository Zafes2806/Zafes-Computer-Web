...
import { requestForgotPassword, requestResetPassword } from '../../api';
...
function ForgotPassword() {
    ...
    const handleSendEmail = async (values) => {
        try {
            ...
            message.error(getFriendlyErrorMessage(error, 'Không thể gửi mã OTP. Vui lòng thử lại!'));
        }
    };
    ...
    const handleResetPassword = async (values) => {
        try {
            ...
            message.error(getFriendlyErrorMessage(error, 'Không thể đặt lại mật khẩu. Vui lòng thử lại!'));
        }
    };
